        ...
        <div className="container mx-auto px-6 z-10 text-center">
          ...
          <Reveal delay={0.4}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <svg className="w-6 h-6 text-[#25D366] group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
